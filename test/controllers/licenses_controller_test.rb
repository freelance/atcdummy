...
class LicensesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create license" do
    assert_difference('License.count') do
      post licenses_url, params: { license: { name: @license.name, number: @license.number } }
    end
  ...
  test "should update license" do
    patch license_url(@license), params: { license: { name: @license.name, number: @license.number } }
